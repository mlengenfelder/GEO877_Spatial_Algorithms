...
1. **Clone or structure your working directory** ensuring all inputs are positioned as shown in the directory map below.
2. **Generate the environment** using the provided environment profile:
   ```bash
